...
async def safe_click(page: Page, selector: str, *, timeout_ms: int = 3000) -> bool:
    """Click nếu tồn tại & visible trong timeout."""
    try:
...
async def run_tiktok_flow(
    ...
    *,
    ...
    """
    Hàm chính: chạy flow TikTok trên 1 page đã được tạo (browser/context đã mở ở index.py).
    """
    ...
    for _ in range(will_view_amount):
        ...
        # press Space random_scroll times (delay 300..900)
        ...
        if video_picked == 2:
            ...
            if has_bridge:
                # placeholder (type 40 trong GPM bạn chưa rõ)
                pass
            else:
